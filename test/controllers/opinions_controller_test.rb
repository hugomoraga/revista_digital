...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { content: @opinion.content, description: @opinion.description, image: @opinion.image, title: @opinion.title } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { content: @opinion.content, description: @opinion.description, image: @opinion.image, title: @opinion.title } }
