...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { month: @magazine.month, name: @magazine.name, year: @magazine.year } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { month: @magazine.month, name: @magazine.name, year: @magazine.year } }
